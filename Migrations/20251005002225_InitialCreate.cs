        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsageFee = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KidsAreas", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedBookingId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_Guests_OrganizerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceDispatches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceDispatches_InventoryItems_InventoryItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Meals_MenuItems_MenuItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HousekeepingSchedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HousekeepingSchedules_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HousekeepingSchedules_RoomId",
                table: "HousekeepingSchedules",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_Meals_MenuItemId",
                table: "Meals",
                column: "MenuItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceDispatches_InventoryItemId",
                table: "ServiceDispatches",
