...
# 3 — UML (PlantUML) — Class & Sequence Diagrams

Create `docs/uml_class.puml`:
...
class HotelService {
  +IEnumerable<Hotel> GetHotels(SearchCriteria c)
...
class ReservationService {
  ...
  +bool CheckAvailability(Guid roomTypeId, Date start, Date end)
